exports.era5 = function(image,time_start) {
    ...
    // filter by geometry
    var DATASET=ee.ImageCollection("ECMWF/ERA5_LAND/HOURLY").filterBounds(image.geometry());
   ...
   // var i_q_med =NEXT_IMAGE.select('Qair_f_inst')
    ...
    var i_q_med =ee.ImageCollection("NASA/GLDAS/V021/NOAH/G025/T3H").select(['Qair_f_inst'],["specific_humidity"]).filterBounds(image.geometry())
