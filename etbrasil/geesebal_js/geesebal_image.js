// -+-+-+-+-+-+-+-+- IMPORTS -+-+-+-+-+-+-+-+-+-
var meteorologicalData = require('users/franciscopuig/advanced_irr_lab/:geesebal_era5');
var endmembers = require('users/franciscopuig/advanced_irr_lab/:geesebal_endmembers');
var tools = require('users/franciscopuig/advanced_irr_lab/:geesebal_tools');
var evapotranspiration = require('users/franciscopuig/advanced_irr_lab/:geesebal_evapotranspiration');
